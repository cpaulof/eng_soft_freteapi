...
INSERT INTO FRETE(descricao, peso, valor, cidade_id, cliente_id) VALUES ('Alimentos nao perecíveis', 900, 200, 1, 3);
INSERT INTO FRETE(descricao, peso, valor, cidade_id, cliente_id) VALUES ('Produtos de Limpeza', 700, 200, 3, 4);
INSERT INTO FRETE(descricao, peso, valor, cidade_id, cliente_id) VALUES ('Carne Resfriada', 600, 200, 3, 2);
INSERT INTO FRETE(descricao, peso, valor, cidade_id, cliente_id) VALUES ('Medicamentos', 100, 200, 3, 4);
--INSERT INTO FRETE(id, descricao, peso, valor, cidade_id, cliente_id) VALUES (333, 'Carne', 100, 200, 2, 4);
